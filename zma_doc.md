...
- 書式: マクロ名 MACRO 引数リスト<br>文<br>ENDM
- 機能
...
- 書式: SCOPE スコープ名<br>文<br>ENDSCOPE
- 機能
...
- 書式: REPEAT ループ変数名, 式<br>文<br>ENDR
- 機能
...
- 書式1 IF 式<br>文<br>ENDIF
- 書式2 IF 式1<br>文1<br>ELSEIF 式2<br>文2<br>ENDIF
- 書式3 IF 式<br>文1<br>ELSE<br>文2<br>ENDIF
- 機能
...
- 書式: LINK トリガー名 [, トリガー名 [, トリガー名 ... ]]<br>中身<br>ENDL
- 機能
...
|Default character sets cannot be mapped and changed.|MAPPING_CHAR命令を、DEFAULTキャラセットに指定
しようとした。|
